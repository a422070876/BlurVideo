...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
  ...
  public void setTimeListener(VideoTimeListener videoTimeListener){
    for (Renderer renderer: renderers){
      if(renderer instanceof MediaCodecVideoRenderer){
        MediaCodecVideoRenderer videoRenderer = (MediaCodecVideoRenderer) renderer;
        videoRenderer.setTimeListener(videoTimeListener);
      }
    }
  }
  public void onDraw(){
